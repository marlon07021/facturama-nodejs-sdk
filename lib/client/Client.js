...
var HttpRequestType_1 = require("./HttpRequestType");
            ...
            return __generator(this, function (_a) {
                try {
                    ...
                    if (request.type === HttpRequestType_1.HTTP_REQUEST_TYPE.GET) {
                        return [2 /*return*/, (0, http_1.GET)(this._config.url + request.path, request.headers)];
                    }
                    else if (request.type === HttpRequestType_1.HTTP_REQUEST_TYPE.POST) {
                        return [2 /*return*/, (0, http_1.POST)(this._config.url + request.path, request.data, request.headers)];
                    }
                    else if (request.type === HttpRequestType_1.HTTP_REQUEST_TYPE.PUT) {
                        return [2 /*return*/, (0, http_1.PUT)(this._config.url + request.path, request.data, request.headers)];
                    }
                    else if (request.type === HttpRequestType_1.HTTP_REQUEST_TYPE.DELETE) {
                        return [2 /*return*/, (0, http_1.DELETE)(this._config.url + request.path, request.data, request.headers)];
                    }
                }
                catch (e) {
