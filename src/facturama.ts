...
export default class FacturamaSDK {
  ...
  public get CDFI(): CFDIApi {
    if (this.loggedIn && this._CDFI) return this._CDFI;
  ...
  public get Retenciones(): RetentionApi {
    if (this.loggedIn && this._Retentions) return this._Retentions;
    else throw new NotInitializedError();
  }
  ...
  public get CSD(): CSDApi {
    if (this.loggedIn && this._CSD) return this._CSD;
    else throw new NotInitializedError();
  }
  ...
  public get Catalogs(): CatalogsApi {
    if (this.loggedIn && this._Catalogs) return this._Catalogs;
    else throw new NotInitializedError();
  }
  ...
  constructor(production: boolean = false, apiUrl?: string) {
    if (apiUrl) {
      ...
      if (production) this._apiUrl = Config.production.apiUrl;
      else this._apiUrl = Config.sandbox.apiUrl;
    }
  }
