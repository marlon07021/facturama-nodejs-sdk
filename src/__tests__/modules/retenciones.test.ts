...
describe('Retenciones module API', () => {
    ...
    test('get retention by id', async () => {
        ...
        expect(axios.get).toHaveBeenCalledWith(`${sdk.ApiUrl}Retenciones/${id}`, {"headers": {"Authorization": "Basic cHJ1ZWJhczpwcnVlYmFzMjAxMQ==", "Content-Type": "application/json"}, "signal": undefined});
    ...
    test('list Retenciones', async () => {
        ...
        expect(axios.get).toHaveBeenCalledWith(`${sdk.ApiUrl}Retenciones`, {"headers": {"Authorization": "Basic cHJ1ZWJhczpwcnVlYmFzMjAxMQ==", "Content-Type": "application/json"}, "signal": undefined});
    ...
    test('create Retencion', async () => {
        ...
        expect(axios.post).toHaveBeenCalledWith(`${sdk.ApiUrl}Retenciones`,{...retencion.json()}, {"headers": {"Authorization": "Basic cHJ1ZWJhczpwcnVlYmFzMjAxMQ==", "Content-Type": "application/json"}, "signal": undefined});
